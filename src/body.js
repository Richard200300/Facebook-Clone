            ...
            <div className="body-post-container" style={style}>
                <section className="body-post-container1">
                    <section className="body-post-main-flex">
                        <section className="body-post-main-flex1">
                            <div className="body-post-img-container">
                                <img src={props.groupdata.groupdp} className="body-post-dp" alt={props.groupdata.groupdp} />
                                <img src={props.groupdata.userdp} className="body-post-inner-dp" alt={props.groupdata.userdp} />
                            </div>
                            <div className="body-post-name">
                                <h3 className="body-post-group-name">{props.groupdata.groupname}</h3>
                                <p className="body-post-user-name">{props.groupdata.username}<span>21 h</span></p>
                            </div>
                        </section>
                    ...
                    <p>{props.groupdata.caption}</p>

                </section>
                <img src={props.groupdata.imageposted} alt={props.groupdata.imageposted} className="body-post-image" />
                <section className="body-post-container2">
                    ...
                    <div className="comment-container">
                        <img src={props.groupdata.userdp} alt={props.groupdata.userdp} className="comment-dp" />
                        <div className="commet1">
                            ...
                            <List items={list} removeItem={removeItem} editItem={editItem} dp={props.groupdata.userdp} username={props.groupdata.username}/>
